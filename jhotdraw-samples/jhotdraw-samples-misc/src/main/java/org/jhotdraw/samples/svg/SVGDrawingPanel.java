...
import org.jhotdraw.samples.svg.gui.CTDefaultStrategy;
import org.jhotdraw.samples.svg.gui.CTExtendedStrategy;
import org.jhotdraw.samples.svg.gui.StateStrategy;
...
public class SVGDrawingPanel extends JPanel implements Disposable {
    ...
    @FeatureEntryPoint(value = "initComponents")
    ...
    private void initComponents() {
        ...
        HashMap<Integer, StateStrategy> stateStrategyMap = new HashMap<Integer, StateStrategy>();
        stateStrategyMap.put(1,new CTDefaultStrategy());
        stateStrategyMap.put(2,new CTExtendedStrategy());
        canvasToolBar = new org.jhotdraw.samples.svg.gui.CanvasToolBar(stateStrategyMap );
